...
### 6.5 Fleet dashboard (v0.2 — limited; v1.0 — full)
...
- Cross-tool: monitors Claude Code, Cursor, Copilot, ChatGPT Desktop, Cursor, Aider, and 11+ others — no other product covers more than two.
...
- [openapi.yaml](./API-CONTRACTS.md) — API contracts for the local daemon and control plane.
