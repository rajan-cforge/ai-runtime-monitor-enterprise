...
Q3 ratification 2026-06-07: weights snapshot onto each
...
Q4 ratification 2026-06-07: orphan ``data_exfiltration_capable``
...
class TestOrphanDerivedTagRaises:
    """Q4 ratification 2026-06-07: if `DATA_EXFILTRATION_CAPABLE` is in
...
class TestWeightsSnapshotOnResult:
    """Q3 ratification 2026-06-07: weights are defined once in
